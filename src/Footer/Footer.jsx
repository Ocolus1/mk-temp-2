...
function Footer() {
  ...
  return (
    <section className="footer-main px-10 py-10">
      <div className="footer-headline mx-auto flex max-w-5xl flex-col gap-x-5 gap-y-5 md:flex-row md:items-start md:justify-between lg:px-10 xl:px-0">
        <div className="left-footer-part flex w-full flex-col items-start justify-start pt-3 md:w-1/2 lg:w-1/3">
          <button>
            <div className="header-logo flex items-center space-x-2">
              <img src={logo} alt="" />
              <h2 className="font-bold text-white">Homely</h2>
            </div>
          </button>
          <p className="mt-5 max-w-xs text-sm font-[400] text-white">
        ...
        <div className="center-footer-part w-1/2 pt-5 lg:w-1/3">
          <div className="flex items-center justify-between gap-x-3 px-0 lg:px-10">
            <ul className="footer-link-list flex flex-col gap-y-5 text-sm font-[400] text-white">
            ...
            <ul className="footer-link-list flex flex-col gap-y-5 text-sm font-[400] text-white/90">
        ...
        <div className="right-footer-part w-full md:w-2/3 lg:w-1/3">
          <div className=" footer-social-container-dark  flex items-center justify-between p-5 border rounded-xl ">
            ...
            <div>
              <button className="footer-social-container-dark-button w-full rounded-lg border border-transparent bg-[#45B3BA] px-5 py-2 text-sm font-bold text-white transition duration-200 hover:shadow-lg hover:shadow-black hover:drop-shadow-lg">
                Follow
              </button>
            </div>
          </div>
